...
class QTreeView(QtGui.QTreeView):
    def __init__(self, MainWindow, targetImageLabel, fsInfoText):
    ...
    def mouseDoubleClickEvent(self, event):
        ...
        p = subprocess.Popen(["python mft_parser %s -i" % target], stdout=PIPE, shell=True)
        output = p.stdout.readline()
        self.fsInfoText.setText(output)
...
class StreamFSInterface(QtGui.QMainWindow):
    ...
    def setup(self, MainWindow):
        ...
        self.commandInput = QtGui.QLineEdit(self.centralwidget)
        self.commandInput.setGeometry(QtCore.QRect(25, 20, 226, 20))
        ...
        self.fsInfoText.setStyleSheet("color: rgb(212, 208, 200);background-color: rgb(212, 208, 200);")
        ...
        self.fileView = QTreeView(self.centralwidget, self.targetImage, self.fsInfoText)
        ...
        self.progressBar.setGeometry(QtCore.QRect(25, 530, 750, 25))
    ...
    def runButtonClicked(self):
        ...
        self.statusView.setText(output)
